view: totals_analytics_monthly_report {
  sql_table_name: `hubspot.totals_analytics_monthly_report` ;;
  ...
  dimension: non_contact_submissions {
    type: number
    sql: ${TABLE}.non_contact_submissions ;;
  }
  ...
  dimension: submissions_per_pageview {
    type: number
    sql: ${TABLE}.submissions_per_pageview ;;
  }
